...
export default class LinkedInModal extends React.Component {
    constructor() {
        ...
        this.renderWebview = () => {
            ...
            return (React.createElement(WebView, { ref: webViewRef, source: { uri: this.getAuthorizationUrl() }, onNavigationStateChange: this.onNavigationStateChange, startInLoadingState: true, javaScriptEnabled: true, domStorageEnabled: true, injectedJavaScript: injectedJavaScript, sharedCookiesEnabled: true, incognito: true, onLoadStart: onLoadStart, onLoadEnd: onLoadEnd, onMessage: onMessage }));
        };
    }
