...
export default class LinkedInModal extends React.Component {
    constructor() {
        ...
        this.renderWebview = () => {
            ...
            return (React.createElement(WebView, { ref: (ref) => this.webView = ref, source: { uri: this.getAuthorizationUrl() }, onNavigationStateChange: this.onNavigationStateChange, startInLoadingState: true, javaScriptEnabled: true, domStorageEnabled: true, injectedJavaScript: injectedJavaScript, sharedCookiesEnabled: true, incognito: true, onLoadStart: this.onLoadStart, onLoadProgress: this.onLoadProgress, onMessage: this.onMessage }));
        };
    }
